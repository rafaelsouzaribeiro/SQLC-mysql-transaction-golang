...
const createCategry = `-- name: CreateCategry :exec
INSERT INTO categories (id,name,description)VALUES(?,?,?)
`

type CreateCategryParams struct {
	ID          string
	Name        string
	Description sql.NullString
}

func (q *Queries) CreateCategry(ctx context.Context, arg CreateCategryParams) error {
	_, err := q.db.ExecContext(ctx, createCategry, arg.ID, arg.Name, arg.Description)
	return err
}
...
SELECT c.id, c.category_id, c.name, c.description, c.price, ca.name as category_name FROM courses c JOIN categories ca 
